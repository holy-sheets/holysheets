...
const combine = <RecordType extends Record<string, string>>(
  data: string[],
 ...
 */
const decombine = <RecordType extends Record<string, string>>(
  record: RecordType,
  headers: SheetHeaders[]
): string[] => {
 ...
 */
async function getHeaders<SheetName extends string>(options: {
  sheet: SheetName
...
type SelectClause<RecordType> = Partial<{
